...
# Use absolute paths for model and CSV
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
model = joblib.load(os.path.join(BASE_DIR, "flight_delay_model.joblib"))
airports_df = pd.read_csv(os.path.join(BASE_DIR, "airport_ids.csv"))
